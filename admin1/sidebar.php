    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./">Peminjaman Alat Kebersihan Sekolah</a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-folder"></i><a href="data-kategori.php">Kategori</a></li>
                            <li><i class="menu-icon fa fa-plus"></i><a href="tambah-kategori.php">Tambah kategori</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-users"></i><a href="data-user-active.php">User Aktif</a></li>
                            <li><i class="menu-icon fa fa-plus"></i><a href="tambah-admin.php">Tambah User</a></li>
